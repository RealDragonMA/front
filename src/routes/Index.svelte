...
{:else}
    {#if title !== ""}
        <div class="w-1/3 h-36 absolute top-5 left-5 flex">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" class="hover:cursor-pointer mr-3" on:click={goBack}><path fill="white" d="M22 12a10 10 0 0 1-10 10A10 10 0 0 1 2 12A10 10 0 0 1 12 2a10 10 0 0 1 10 10M7 12l5 5v-3h4v-4h-4V7l-5 5Z"/></svg>
    ...
    <div class="w-full absolute bottom-10 flex flex-row gap-6 justify-center p-8">
        {#each responses as response}
            <div class="h-36" on:click={() => myChoice = response.id}>
